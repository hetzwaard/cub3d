...
// include: /tmp/tmpuu1o8ncm.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'web/cub3d.data';
...
Module['FS_createPath']("/", "maps", true, true);
    ...
    for (var file of metadata['files']) {
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['removeRunDependency'](`fp ${name}`);
          ...
          Module['removeRunDependency']('datafile_web/cub3d.data');
      }
      Module['addRunDependency']('datafile_web/cub3d.data');
    ...
    loadPackage({"files": [{"filename": "/assets/east.xpm42", "start": 0, "end": 314}, {"filename": "/assets/key.xpm42", "start": 314, "end": 641}, {"filename": "/assets/north.xpm42", "start": 641, "end": 955}, {"filename": "/assets/south.xpm42", "start": 955, "end": 1269}, {"filename": "/assets/west.xpm42", "start": 1269, "end": 1583}, {"filename": "/maps/1test.cub", "start": 1583, "end": 1931}, {"filename": "/maps/default.cub", "start": 1931, "end": 2580}, {"filename": "/maps/man_test.cub", "start": 2580, "end": 3153}, {"filename": "/maps/test.cub", "start": 3153, "end": 3726}, {"filename": "/maps/wall.cub", "start": 3726, "end": 3893}], "remote_package_size": 3893});

  })();

// end include: /tmp/tmpuu1o8ncm.js
// include: /tmp/tmpoxl3h5wv.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /tmp/tmpoxl3h5wv.js
// include: /tmp/tmpsijb6k_7.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /tmp/tmpsijb6k_7.js
